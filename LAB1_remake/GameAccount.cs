...
namespace MyGame {
    public class GameAccount {
        ...
        private void WinGame(GameAccount opponent, int rating) {
            ...
            var gameLog = new GameLogs(UserName, CurrentRating, opponent.UserName, opponent.CurrentRating, "Win", GameLogs.gameIDSeed, rating);
            allGames.Add(gameLog);
        }
        private void LoseGame(GameAccount opponent, int rating) {
            CurrentRating -= rating;
            
            var gameLog = new GameLogs(UserName, CurrentRating, opponent.UserName, opponent.CurrentRating, "Lose", GameLogs.gameIDSeed, rating);
            allGames.Add(gameLog);
        }
